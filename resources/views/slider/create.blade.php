                        ...
                        <form action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" placeholder="Название слайда" name="title" value="{{ old('title') }}">
                                </div>
                                <div class="form-group">
                                    <label for="description">Описание</label>
                                    <input type="text" class="form-control" id="description" placeholder="Краткое описание" name="description" value="{{ old('description') }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="group_id" id="group_id" class="form-control">
                                        ...
                                        @foreach ($groups as $group)
                                            <option value="{{ $group->id }}" @selected((string) old('group_id') === (string) $group->id)>{{ $group->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
